...
[TestFixture]
public class UpdateEntryDtoValidatorTests
{
    private UpdateEntryDtoValidator _validator = null!;

    [SetUp]
    public void Setup()
    {
        _validator = new UpdateEntryDtoValidator();
    }

    [Test]
    public void Should_HaveError_When_TitleIsEmpty()
    {
        var dto = new UpdateEntryDto { Title = string.Empty };
    ...
    {
        var dto = new UpdateEntryDto { Title = new string('a', 201) };
        var result = _validator.TestValidate(dto);
        result.ShouldHaveValidationErrorFor(x => x.Title);
    }
    ...
    {
        var dto = new UpdateEntryDto { Description = new string('a', 1001) };
        var result = _validator.TestValidate(dto);
